...
// Add new image
export async function addGreqiImage(title: string, imageBase64: string): Promise<void> {
    try {
...
export async function updateGreqiImage(id: string, title: string, imageBase64?: string): Promise<void> {
    try {
